  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        var fpsFourk = pc.fpsFourk !== null ? pc.fpsFourk + "FPS" : "N/A"; // Check if 4kfps value is null
        var fpsTenEighty = pc.fpsTenEighty !== null ? pc.fpsTenEighty + "FPS" : "N/A"; // Check if 1080fps value is null
